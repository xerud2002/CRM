...
import { Lead, LeadStatus, ContactStatus, Activity, ActivityType } from '../entities';
...
export class LeadsService {
    ...
    async findAll(filter: LeadFilterDto) {
        ...
        if (filter.status) {
            ...
            query.andWhere('lead.status != :pendingStatus', { pendingStatus: LeadStatus.PENDING });
        }
    ...
    async create(createLeadDto: CreateLeadDto, userId?: string) {
        ...
        // Log activity
        await this.logActivity(savedLead.id, ActivityType.STATUS_CHANGE, 'Lead created', userId);
    ...
    async accept(id: string, userId?: string) {
        ...
        await this.logActivity(id, ActivityType.STATUS_CHANGE, 'Lead accepted', userId);
    ...
    async reject(id: string, userId?: string) {
        ...
        await this.logActivity(id, ActivityType.STATUS_CHANGE, 'Lead rejected', userId);
